...
public class StringBufferFunctions {
	...
	public static void main(String[] args) {
		...
		s.append("This is a java class");

		StringBuffer sb=new StringBuffer("");
		sb.append("This is a java class");
		...
		System.out
				.println("Replace java with SQL: " + sb.replace(javaIndex, (javaIndex + 4), "SQL"));
		System.out.println("Letter at the center:"+s.charAt((s.length()-1) / 2));
		...
		System.out.println("Convert the entire String in to upper case ? "+s.toString().toUpperCase());
